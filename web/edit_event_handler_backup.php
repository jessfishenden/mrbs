...
$client_name = get_form_var('client_name', 'string'); 
$client_address = get_form_var('client_address', 'string'); 
$client_phone = get_form_var('client_phone', 'string'); 
$client_email = get_form_var('client_email', 'string'); 
$no_of_attendees = get_form_var('no_of_attendees', 'int'); 
$refreshments_required = get_form_var('refreshments_required', 'string'); 
$flipchart_required = get_form_var('flipchart_required', 'string'); 
$flipchart_paper_pack_required = get_form_var('flipchart_paper_pack_required', 'string'); 
$pen_pack_required = get_form_var('pen_pack_required', 'string'); 
